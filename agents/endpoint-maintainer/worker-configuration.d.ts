/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: faca5f3d88f0d36993d78cd914d464b8)
// Runtime types generated with workerd@1.20260521.1 2026-05-23 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	CHRISTOPHER_BASE_URL: "http://127.0.0.1:8090";
	ChristopherEndpointMaintainer: DurableObjectNamespace<import("./src/index").ChristopherEndpointMaintainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChristopherEndpointMaintainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHRISTOPHER_BASE_URL">> {}
}
